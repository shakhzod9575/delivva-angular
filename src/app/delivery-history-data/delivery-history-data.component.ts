...
@Component({
  selector: 'app-delivery-history-data',
  templateUrl: './delivery-history-data.component.html',
  styleUrls: ['./delivery-history-data.component.css']
})
export class DeliveryHistoryDataComponent implements OnInit{
